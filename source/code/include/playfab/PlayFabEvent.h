...
namespace PlayFab
{
    ...
    public:
        ...
        void SetNamespace(const std::string& eventNamespace); // Sets the event namespace (Bumblelion only)
        void SetEntity(const PlayFabInternal::EventsModels::EntityKey& entity); // Set EntityToken (bumblelion only)
